...
all: mol.o libmol.so molecule_wrap.o _molecule.so
...
_molecule.so: molecule_wrap.o libmol.so
	$(CC) molecule_wrap.o -shared -lpython3.7m -lmol -dynamiclib -L/usr/lib/python3.7/config-3.7m-x86_64-linux-gnu -L. -o _molecule.so
